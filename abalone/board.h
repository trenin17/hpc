...
class Board
{
 ...
 public:
  ...
  Board& operator =(const Board& b)
  {
    ...
    color1Count = b.color1Count;
    color2Count = b.color2Count;
    color = b.color;
    for (int i = 0; i < MvsStored; i++) {
      storedMove[i] = b.storedMove[i];
    }
    storedFirst = b.storedFirst;
    storedLast = b.storedLast;
    _moveNo = b._moveNo;
    _msecsToPlay[0] = b._msecsToPlay[0];
    _msecsToPlay[1] = b._msecsToPlay[1];
    _msecsToPlay[2] = b._msecsToPlay[2];
    show = b.show;
    bUpdateSpy = b.bUpdateSpy;
    spyLevel = b.spyLevel;
    spyDepth = b.spyDepth;
    _ss = b._ss;
    _ev = b._ev;
