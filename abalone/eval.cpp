...
// Default Values
static int defaultRingValue[] = { 35, 35, 25, 15, 15 };
static int defaultRingDiff[]  = {  0, 10, 10,  10, 10 };
static int defaultStoneValue[]= { 0,-800,-1800,-3000,-4400,-6000 };
static int defaultMoveValue[Move::typeCount] = { 45,40,35, 25,20,15, 
						 5,5,5, 2,2,2, 1 };
static int defaultInARowValue[MoveCounter::inARowCount]= { 2, 5, 6, 3 };


/**
 * Constructor: Set Default values
 */
EvalScheme::EvalScheme(int s)
{
  switch (s)
  {
  case 0:
...
void Evaluator::setEvalScheme(int s)
{
  _evalScheme = new EvalScheme(s);
  setFieldValues();
}
...
void EvalScheme::setConquerMiddle()
{
  int defaultRingValue[] = { 80, 70, 20, 10, 0 };
  int defaultRingDiff[]  = {  0, 5, 8,  8, 5 };
  int defaultStoneValue[]= { 0,-400,-1000,-2000,-3500,-5000 };
  int defaultMoveValue[Move::typeCount] = { 40,30,30, 15,14,13, 
              5,5,5, 2,2,2, 1 };
  int defaultInARowValue[MoveCounter::inARowCount]= { 2, 3, 3, 2 };
...
void EvalScheme::setAggressive()
{
 int defaultRingValue[] = { 0, 10, 10, 10, 10 };
 int defaultRingDiff[]  = {  0, 0, 0,  0, 0 };
 int defaultStoneValue[]= { 0,-200,-300,-1000,-5000,-7000 };
 int defaultMoveValue[Move::typeCount] = { 80,50,50, 15,14,13, 
						 5,5,5, 2,2,2, 1 };
 int defaultInARowValue[MoveCounter::inARowCount]= { 0, 2, 5, 15 };
